...
class CheckStatusState(sgqlc.types.Enum):
    __schema__ = github_schema
    __choices__ = ('QUEUED', 'IN_PROGRESS', 'COMPLETED', 'WAITING', 'PENDING', 'REQUESTED')
...
class PackageType(sgqlc.types.Enum):
    __schema__ = github_schema
    __choices__ = ('NPM', 'RUBYGEMS', 'MAVEN', 'DEBIAN', 'NUGET', 'PYPI')
...
class PinnedDiscussionGradient(sgqlc.types.Enum):
    __schema__ = github_schema
    __choices__ = ('RED_ORANGE', 'BLUE_MINT', 'BLUE_PURPLE', 'PINK_BLUE', 'PURPLE_CORAL')


class PinnedDiscussionPattern(sgqlc.types.Enum):
    __schema__ = github_schema
    __choices__ = ('DOT_FILL', 'PLUS', 'ZAP', 'CHEVRON_UP', 'DOT', 'HEART_FILL')
...
class RequestableCheckStatusState(sgqlc.types.Enum):
    __schema__ = github_schema
    __choices__ = ('QUEUED', 'IN_PROGRESS', 'COMPLETED', 'WAITING', 'PENDING')
...
class SearchType(sgqlc.types.Enum):
    __schema__ = github_schema
    __choices__ = ('ISSUE', 'REPOSITORY', 'USER', 'DISCUSSION')


class SecurityAdvisoryEcosystem(sgqlc.types.Enum):
    __schema__ = github_schema
    __choices__ = ('COMPOSER', 'GO', 'MAVEN', 'NPM', 'NUGET', 'PIP', 'RUBYGEMS', 'OTHER')
...
class SponsorsActivityAction(sgqlc.types.Enum):
    __schema__ = github_schema
    __choices__ = ('NEW_SPONSORSHIP', 'CANCELLED_SPONSORSHIP', 'TIER_CHANGE', 'REFUND', 'PENDING_CHANGE', 'SPONSOR_MATCH_DISABLED')
...
class SponsorsActivityPeriod(sgqlc.types.Enum):
    __schema__ = github_schema
    __choices__ = ('DAY', 'WEEK', 'MONTH', 'ALL')
...
class CreateBranchProtectionRuleInput(sgqlc.types.Input):
    __schema__ = github_schema
    __field_names__ = ('repository_id', 'pattern', 'requires_approving_reviews', 'required_approving_review_count', 'requires_commit_signatures', 'requires_linear_history', 'allows_force_pushes', 'allows_deletions', 'is_admin_enforced', 'requires_status_checks', 'requires_strict_status_checks', 'requires_code_owner_reviews', 'dismisses_stale_reviews', 'restricts_review_dismissals', 'review_dismissal_actor_ids', 'restricts_pushes', 'push_actor_ids', 'required_status_check_contexts', 'requires_conversation_resolution', 'client_mutation_id')
    repository_id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='repositoryId')
...
class UpdateBranchProtectionRuleInput(sgqlc.types.Input):
    __schema__ = github_schema
    __field_names__ = ('branch_protection_rule_id', 'pattern', 'requires_approving_reviews', 'required_approving_review_count', 'requires_commit_signatures', 'requires_linear_history', 'allows_force_pushes', 'allows_deletions', 'is_admin_enforced', 'requires_status_checks', 'requires_strict_status_checks', 'requires_code_owner_reviews', 'dismisses_stale_reviews', 'restricts_review_dismissals', 'review_dismissal_actor_ids', 'restricts_pushes', 'push_actor_ids', 'required_status_check_contexts', 'requires_conversation_resolution', 'client_mutation_id')
    branch_protection_rule_id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='branchProtectionRuleId')
...
class Sponsorable(sgqlc.types.Interface):
    __schema__ = github_schema
    __field_names__ = ('has_sponsors_listing', 'is_sponsored_by', 'is_sponsoring_viewer', 'sponsors_activities', 'sponsors_listing', 'sponsorship_for_viewer_as_sponsor', 'sponsorships_as_maintainer', 'sponsorships_as_sponsor', 'viewer_can_sponsor', 'viewer_is_sponsoring')
...
class DeploymentProtectionRule(sgqlc.types.Type, Node):
    __schema__ = github_schema
...
class Issue(sgqlc.types.Type, Node, Assignable, Closable, Comment, Updatable, UpdatableComment, Labelable, Lockable, Reactable, RepositoryNode, Subscribable, UniformResourceLocatable):
    __schema__ = github_schema
    __field_names__ = ('body_resource_path', 'body_url', 'comments', 'hovercard', 'is_pinned', 'is_read_by_viewer', 'milestone', 'number', 'participants', 'project_cards', 'state', 'timeline_items', 'title', 'title_html')
...
class Organization(sgqlc.types.Type, Node, Actor, PackageOwner, ProjectOwner, RepositoryDiscussionAuthor, RepositoryDiscussionCommentAuthor, RepositoryOwner, UniformResourceLocatable, MemberStatusable, ProfileOwner, Sponsorable):
    __schema__ = github_schema
    __field_names__ = ('audit_log', 'created_at', 'database_id', 'description', 'description_html', 'domains', 'interaction_ability', 'ip_allow_list_enabled_setting', 'ip_allow_list_entries', 'ip_allow_list_for_installed_apps_enabled_setting', 'is_verified', 'members_with_role', 'new_team_resource_path', 'new_team_url', 'notification_delivery_restriction_enabled_setting', 'organization_billing_email', 'pending_members', 'requires_two_factor_authentication', 'saml_identity_provider', 'team', 'teams', 'teams_resource_path', 'teams_url', 'twitter_username', 'updated_at', 'viewer_can_administer', 'viewer_can_create_repositories', 'viewer_can_create_teams', 'viewer_is_amember')
...
class PullRequest(sgqlc.types.Type, Node, Assignable, Closable, Comment, Updatable, UpdatableComment, Labelable, Lockable, Reactable, RepositoryNode, Subscribable, UniformResourceLocatable):
    __schema__ = github_schema
    __field_names__ = ('additions', 'auto_merge_request', 'base_ref', 'base_ref_name', 'base_ref_oid', 'base_repository', 'changed_files', 'checks_resource_path', 'checks_url', 'closing_issues_references', 'comments', 'commits', 'deletions', 'files', 'head_ref', 'head_ref_name', 'head_ref_oid', 'head_repository', 'head_repository_owner', 'hovercard', 'is_cross_repository', 'is_draft', 'is_read_by_viewer', 'latest_opinionated_reviews', 'latest_reviews', 'maintainer_can_modify', 'merge_commit', 'mergeable', 'merged', 'merged_at', 'merged_by', 'milestone', 'number', 'participants', 'permalink', 'potential_merge_commit', 'project_cards', 'revert_resource_path', 'revert_url', 'review_decision', 'review_requests', 'review_threads', 'reviews', 'state', 'suggested_reviewers', 'timeline_items', 'title', 'title_html', 'viewer_can_apply_suggestion', 'viewer_can_delete_head_ref', 'viewer_can_disable_auto_merge', 'viewer_can_enable_auto_merge', 'viewer_latest_review', 'viewer_latest_review_request', 'viewer_merge_body_text', 'viewer_merge_headline_text')
    additions = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='additions')
...
class Repository(sgqlc.types.Type, Node, ProjectOwner, PackageOwner, Subscribable, Starrable, UniformResourceLocatable, RepositoryInfo):
    __schema__ = github_schema
    __field_names__ = ('assignable_users', 'branch_protection_rules', 'code_of_conduct', 'collaborators', 'commit_comments', 'contact_links', 'database_id', 'default_branch_ref', 'delete_branch_on_merge', 'deploy_keys', 'deployments', 'discussion', 'discussion_categories', 'discussions', 'disk_usage', 'environment', 'environments', 'forks', 'funding_links', 'interaction_ability', 'is_blank_issues_enabled', 'is_disabled', 'is_empty', 'is_security_policy_enabled', 'is_user_configuration_repository', 'issue', 'issue_or_pull_request', 'issue_templates', 'issues', 'label', 'labels', 'languages', 'latest_release', 'mentionable_users', 'merge_commit_allowed', 'milestone', 'milestones', 'object', 'parent', 'pinned_discussions', 'pinned_issues', 'primary_language', 'pull_request', 'pull_request_templates', 'pull_requests', 'rebase_merge_allowed', 'ref', 'refs', 'release', 'releases', 'repository_topics', 'security_policy_url', 'squash_merge_allowed', 'ssh_url', 'submodules', 'temp_clone_token', 'template_repository', 'viewer_can_administer', 'viewer_can_update_topics', 'viewer_default_commit_email', 'viewer_default_merge_method', 'viewer_permission', 'viewer_possible_commit_emails', 'vulnerability_alerts', 'watchers')
...
class User(sgqlc.types.Type, Node, Actor, PackageOwner, ProjectOwner, RepositoryDiscussionAuthor, RepositoryDiscussionCommentAuthor, RepositoryOwner, UniformResourceLocatable, ProfileOwner, Sponsorable):
    __schema__ = github_schema
